  ...
  <body>
    ...
    <div class="d-flex align-items-stretch">
      ...
      <div class="container" align="center" style="text-align:center; margin-top:35px">
        ...
        <h1 style="text-align:center; text-decoration:underline; font-size:30px; color:green">KW Pillars</h1>
        <br>
...
<div style="border:3px solid red; padding:10px; border-radius:150px 10px 150px 10px">
        ...
        <form action="{{route('import')}}" method="post" enctype="multipart/form-data">
          ...
          <a href="{{route('export')}}" class="btn btn-info">Export Data</a> <br><br>

        </form>
  </div> <br><br><br>

      <form style="" class="form" action="{{url('addkwpillars')}}" method="post" enctype="multipart/form-data">
          @csrf
